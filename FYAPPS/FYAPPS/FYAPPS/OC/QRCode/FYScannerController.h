 ...
 * 能够识别相册图片中的二维码(iOS 64 位设备)
 ...
 // 实例化控制器，并指定完成回调
 FYScannerController *scanner = [FYScannerController scannerWithCardName:cardName avatar:avatar completion:^(NSString *stringValue) {
 ...
 @endcode
 */
@interface FYScannerController : UINavigationController
