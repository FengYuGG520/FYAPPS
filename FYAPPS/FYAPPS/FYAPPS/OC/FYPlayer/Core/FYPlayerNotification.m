...
@interface FYPlayerNotification ()

@property (nonatomic, assign) FYPlayerBackgroundState backgroundState;

@end

@implementation FYPlayerNotification
...
- (void)applicationWillResignActiveNotification {
    self.backgroundState = FYPlayerBackgroundStateBackground;
    if (_willResignActive) _willResignActive(self);
}

- (void)applicationDidBecomeActiveNotification {
    self.backgroundState = FYPlayerBackgroundStateForeground;
