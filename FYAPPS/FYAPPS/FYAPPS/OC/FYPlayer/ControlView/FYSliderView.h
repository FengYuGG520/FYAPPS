...
@protocol FYSliderViewDelegate <NSObject>
...
@interface FYSliderButton : UIButton

@end

@interface FYSliderView : UIView

@property (nonatomic, weak) id<FYSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) FYSliderButton *sliderBtn;
