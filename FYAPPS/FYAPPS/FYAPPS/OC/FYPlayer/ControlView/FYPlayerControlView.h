...
@interface FYPlayerControlView : UIView <FYPlayerMediaControl>

/// 竖屏控制层的View
@property (nonatomic, strong, readonly) FYPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) FYLandScapeControlView *landScapeControlView;

/// 加载loading
@property (nonatomic, strong, readonly) FYSpeedLoadingView *activity;

/// 快进快退View
@property (nonatomic, strong, readonly) UIView *fastView;

/// 快进快退进度progress
@property (nonatomic, strong, readonly) FYSliderView *fastProgressView;
...
/// 底部播放进度
@property (nonatomic, strong, readonly) FYSliderView *bottomPgrogress;
